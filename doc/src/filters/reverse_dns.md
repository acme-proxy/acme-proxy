...
**`require_forward_confirm`** (`Boolean`)  
*Default: `true` | Env: `ACME_PROXY_FILTER__REVERSE_DNS__REQUIRE_FORWARD_CONFIRM`*  
Require the PTR record to correctly forward-resolve back to the IP.

**`allow`** (`Array`)  
*Default: `[]` | Env: `ACME_PROXY_FILTER__REVERSE_DNS__ALLOW`*  
List of regex patterns to allow.

**`deny`** (`Array`)  
*Default: `[]` | Env: `ACME_PROXY_FILTER__REVERSE_DNS__DENY`*  
List of regex patterns to deny.

**`timeout_ms`** (`Integer`)  
*Default: `2000` | Env: `ACME_PROXY_FILTER__REVERSE_DNS__TIMEOUT_MS`*  
